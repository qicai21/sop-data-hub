#!/usr/bin/env python3
"""R82: contract-fee structures migration runner.

Usage:
  python scripts/run_r82_contract_fee_migration.py
  python scripts/run_r82_contract_fee_migration.py --apply
"""
...
MIGRATION_SQL = REPO_ROOT / "migrations" / "20260702_r82_contract_fee_structures.sql"
