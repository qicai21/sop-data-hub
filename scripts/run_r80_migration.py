#!/usr/bin/env python3
"""R80: cycle_train schema migration runner — apply 20260610_r80_cycle_train_schema.sql.
...
Usage:
  python scripts/run_r80_migration.py            # dry-run
  python scripts/run_r80_migration.py --apply    # 真正提交
"""
...
MIGRATION_SQL = REPO_ROOT / "migrations" / "20260610_r80_cycle_train_schema.sql"
...
def apply_migration(db_path: Path, apply: bool) -> None:
    ...
    final_sql = "\n".join(safe_lines)
    print("=== SQL to run ===")
    print(final_sql[:2000] + ("..." if len(final_sql) > 2000 else ""))
